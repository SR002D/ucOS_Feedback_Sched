...
tcb_ext_info task_info_array[] = {
	{0,0,1,4,1,4,0},{0,0,2,5,2,5,0},{0,0,2,10,2,10,0}
};
...
void createTasks() {
	...
	//task_info_array[2].resource = device;	//device资源锁，共享的信号量 
	...
	OSTaskCreateExt(Task1,                //指向任务代码的指针
		...
		task_info_array[0].p,          //id是任务的标识，不可与优先级相同
